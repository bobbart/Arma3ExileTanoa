...
/* Mission System Settings */
	...
	DMS_MissionTimeoutResetRange		= 0;						// If a player is this close to a mission then it won't time-out. Set to 0 to disable this check.
	...
	DMS_MissionMarkerWinDotTime			= 280;						// How many seconds the "win" mission dot will remain on the map
	DMS_MissionMarkerLoseDotTime		= 280;						// How many seconds the "lose" mission dot will remain on the map
	...
	DMS_AttemptsUntilThrottle			= 10;						// How many attempts until the parameters are throttled.
	...
	DMS_MinThrottledDistance			= 400;						// The minimum distance to which it will throttle. If the throttled value is less than this value, then this value is used instead.
	...
	DMS_TraderZoneNearBlacklist			= 3500;						// Missions won't spawn in a position this many meters close to a trader zone
	...
	DMS_ContaminatedZoneNearBlacklist	= 800;						// Missions won't spawn in a position this many meters close to a contaminated zone
	DMS_MinSurfaceNormal				= 0.7;						// Missions won't spawn in a position where its surfaceNormal is less than this amount. The lower the value, the steeper the location. Greater values means flatter locations. Values can range from 0-1, with 0 being sideways, and 1 being perfectly flat. For reference: SurfaceNormal of about 0.7 is when you are forced to walk up a surface. If you want to convert surfaceNormal to degrees, use the arc-cosine of the surfaceNormal. 0.9 is about 25 degrees. Google "(arccos 0.9) in degrees"
	DMS_MinDistFromWestBorder			= 150;						// Missions won't spawn in a position this many meters close to the western map border.
	DMS_MinDistFromEastBorder			= 150;						// Missions won't spawn in a position this many meters close to the easter map border.
	DMS_MinDistFromSouthBorder			= 150;						// Missions won't spawn in a position this many meters close to the southern map border.
	DMS_MinDistFromNorthBorder			= 150;						// Missions won't spawn in a position this many meters close to the northern map border.
	...
	DMS_MineInfo_moderate				= [10,75];					// Mine info for "moderate" missions. This will spawn 10 mines within a 50m radius.
	DMS_MineInfo_difficult				= [15,100];					// Mine info for "difficult" missions. This will spawn 15 mines within a 75m radius.
	DMS_MineInfo_hardcore				= [25,150];					// Mine info for "hardcore" missions. This will spawn 25 mines within a 100m radius.
...
/* AI Settings */
	...
	DMS_Bandit_Static_RepGain			= 75;						// The amount of Respect gained for killing a bandit static gunner
	...
	DMS_Bandit_Vehicle_RepGain			= 100;						// The amount of Respect gained for killing a bandit vehicle crew member
...
/* DonkeyPunchDMS Custom Settings for Hero AI*/
	...
	DMS_Hero_Soldier_RepGain			= 100;						// The amount of Respect gained for killing a hero soldier
	...
	DMS_Hero_Static_RepGain				= 120;						// The amount of Respect gained for killing a hero static gunner
	...
	DMS_Hero_Vehicle_RepGain			= 200;						// The amount of Respect gained for killing a hero vehicle crew member
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_AI_WP_Radius_easy				= 40;						// Waypoint radius for "easy" AI.
	DMS_AI_WP_Radius_moderate			= 60;						// Waypoint radius for "moderate" AI.
	DMS_AI_WP_Radius_difficult			= 75;						// Waypoint radius for "difficult" AI.
	DMS_AI_WP_Radius_hardcore			= 100;						// Waypoint radius for "hardcore" AI.
	...
	DMS_AI_destroyVehicleChance			= 15;						// Percent chance that an AI vehicle will be destroyed after the AI have been killed. Set to 100 for always, or 0 for never.

	DMS_AI_destroyStaticWeapon			= true;						// Whether or not to destroy static HMGs after AI death.
	DMS_AI_destroyStaticWeapon_chance	= 45;						// Percent chance that a static weapon will be destroyed (only applied if "DMS_AI_destroyStaticWeapon" is true)
	...
	DMS_ai_use_launchers_chance			= 45;						// Percentage chance to actually spawn the launcher (per-unit). With "DMS_ai_launchers_per_group" set to 2, and "DMS_ai_use_launchers_chance" set to 50, there will be an average of 1 launcher per group.
	...
	DMS_RHeli_Height					= 200;						// Altitude of the heli when flying to drop point.
	DMS_RHeli_MinDistFromDrop			= 1500;						// Minimum distance for the reinforcement heli to spawn from drop point.
