...
*/
serverCommandPassword = "Bob@195bart";
...
hiddenSuperAdmin[] =
{
	"76561197994787517","76561198090688251","76561198126945591","..."
};

adminUIDandAccess[] =
{
	{
		{"76561197994787517","UID2","UID3","..."},	/* Admins with UIDs in this Array have their Access defined in the array below. */
		{
...
CHECK_RECOIL = "true";		/* checks weapon recoil */
...
{
	/* default idds */
	-1,0,4,5,6,8,12,15,18,24,49,54,55,70,101,160,174,177,999,131,63,602,301,
...
blacklistedVariables[] =
{
	...
	"sni_prz_zzz_targetplayer","healit","o_fnc_arma","mlrn_exec","running_threads","catchemall14654","killtarget","gmtoggle","t1","fuck_me_keyp","cheatcurator"
};
